...
// 初期化パラメーターの設定
@WebServlet(
		urlPatterns = {"/CounterServlet_Listener"},
		initParams = {
				@WebInitParam( name = "bgcolor", value = "yellow" )
		})

public class CounterServlet_Listener extends HttpServlet {
...
//		application.setAttribute("count", count);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<a href=\"/sample11/CounterServlet_Listener\">更新</a>");
		out.println("</body>");
		out.println("</html>");
	}
